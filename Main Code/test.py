...
class TestModule(object):
    ...
    def test(self, args, down_ratio):
        ...
        # Create a folder to save resulting images if it doesn't exist
        ...
        for cnt, data_dict in enumerate(data_loader):
            ...
            # Save the resulting image in the 'results' folder
            result_image_path = os.path.join(result_folder, 'result_{}.png'.format(cnt))
            cv2.imwrite(result_image_path, ori_image)
