...
import sys
#sys.path.insert(0,'..')
sys.path.append(os.path.abspath('/media/admin-pc/553fc288-2848-4466-8476-73e6b1b2bbd4/BBAvector/BBAvectors-Oriented-Object-Detection/datasets/DOTA_devkit'))
try:
